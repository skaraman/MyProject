...
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        {
            [ForceFill(errorMessage = "Some error message!!")]
            public GameObject gob1;

            [Tooltip("Would not trigger for prefabs that "
                + "are not placed in a scene")]
            // Note: This demo scene counts as ScriptableObject
            [ForceFill(skipOnPrefabIsolation = true)]
            ...
            // Test it by starting your game and then look back on this editor window
