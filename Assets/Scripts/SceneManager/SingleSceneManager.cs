...
public partial class SingleSceneManager : MonoBehaviour {
  ...
  private int renderedLoadingPercent = -1;
  private string renderedLoadingStatusDetail = "";
  private float nextLoadingTextRenderAt = -1f;
  ...
  public static bool IsGameplayDialogActive => instance != null && instance.dialogInputOverrideActive;
  ...
  const float loadingTextRenderIntervalSeconds = 0.1f;
  ...
  readonly List<GearController> playerControllerResolveScratch = new(8);
  ...
  readonly List<SpriteWithNormals> preUnlockVisibleSpriteTargetsCache = new(1024);
  Comparison<SpriteWithNormals> preUnlockTargetPriorityComparison;
  Vector3 preUnlockTargetSortPlayerPosition;
  bool preUnlockTargetSortHasPlayer;
  bool preUnlockVisibleSpriteTargetsCacheValid;
  ...
  readonly List<string> preUnlockResidentPinAddressScratch = new(preUnlockResidentPinMaxAddresses);
  readonly List<string> preUnlockResidentPinReadyAddressScratch = new(preUnlockResidentPinMaxAddresses);
  ...
  readonly List<string> persistentAtlasAddressScratch = new(2048);
  readonly HashSet<string> persistentAtlasSeenAddressScratch = new(StringComparer.OrdinalIgnoreCase);
  readonly List<string> persistentPlayerAppearanceAtlasAddresses = new(2048);
  readonly List<string> persistentPlayerEffectAtlasAddresses = new(2048);
  int persistentFontAtlasContentVersion = -1;
  int persistentFontAtlasPinCount;
  int loadingTextFontContentVersion = -1;
  string loadingTextFontPinnedAddress = "";
  ...
  readonly List<string> playerBootstrapWarmAddressScratch = new(2048);
  ...
  void OnDestroy() {
    ...
    TextureResidencyCache.ReleaseOwnerPins(LoadingTextFontPinOwnerId);
    ...
    persistentFontAtlasContentVersion = -1;
    persistentFontAtlasPinCount = 0;
    loadingTextFontContentVersion = -1;
    loadingTextFontPinnedAddress = "";
