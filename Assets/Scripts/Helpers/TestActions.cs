...
public partial class @TestActions: IInputActionCollection2, IDisposable
{
    ...
    ""controlSchemes"": [
        ...
        m_settings_select = m_settings.FindAction("select", throwIfNotFound: true);
    ...
    ~@TestActions()
    {
        ...
        UnityEngine.Debug.Assert(!m_settings.enabled, "This will cause a leak and performance issues, TestActions.settings.Disable() has not been called.");
    ...
    private readonly InputAction m_settings_select;
    ...
    public struct SettingsActions
    {
        ...
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public SettingsActions(@TestActions wrapper) { m_Wrapper = wrapper; }
        /// <summary>
        ...
        /// <summary>
        /// Provides access to the underlying input action "settings/select".
        /// </summary>
        public InputAction @select => m_Wrapper.m_settings_select;
        /// <summary>
        /// Provides access to the underlying input action "settings/cancel".
        /// </summary>
