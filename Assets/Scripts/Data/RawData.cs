...
public static class Animations {
  public static Dictionary<string, AnimData> Esperanza { get; } = new Dictionary<string, AnimData> {
    ...
    { "Blast", new AnimData { start = 1, end = 60, duration = 1000 } },
    ...
    { "BlastToPunchLeft", new AnimData { start = 171, end = 187, duration = 175, To = 2 } },
    { "BlastToPunchRight", new AnimData { start = 188, end = 204, duration = 175, To = 2 } },
    { "BlastToStance", new AnimData { start = 154, end = 170, duration = 175, To = 2 } },

    { "DanceToBlast", new AnimData { start = 137, end = 153, duration = 175, To = 2 } },
    { "PunchLeftToBlast", new AnimData { start = 69, end = 85, duration = 175, To = 2 } },
    { "PunchRightToBlast", new AnimData { start = 86, end = 102, duration = 175, To = 2 } },
    { "KickLeftToBlast", new AnimData { start = 120, end = 136, duration = 175, To = 2 } },
    { "KickRightToBlast", new AnimData { start = 103, end = 119, duration = 175, To = 2 } },
    { "RunToBlast", new AnimData { start = 52, end = 68, duration = 175, To = 2 } },
    { "SprintToBlast", new AnimData { start = 35, end = 51, duration = 175, To = 2 } },
    { "StanceToBlast", new AnimData { start = 18, end = 34, duration = 175, To = 2 } },
    { "WalkToBlast", new AnimData { start = 1, end = 17, duration = 175, To = 2 } },
