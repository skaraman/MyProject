...
public static class EsperanzaGearParts {
  ...
  public static Dictionary<string, string> GearNames { get; } = new Dictionary<string, string> {
    { "Aqua_aa_Chest", "Aqua Chest" },
    { "Aqua_aa_Legs", "Aqua Legs" },
    { "Aqua_ab_Arms", "Aqua Arms" },
    { "Aqua_ab_Chest", "Aqua Chest" },
    { "Aqua_ab_Feet", "Aqua Feet" },
    { "Aqua_ab_Head", "Aqua Head" },
    { "Aqua_ab_Legs", "Aqua Legs" },
    { "Aqua_ab_Shoulders", "Aqua Shoulders" },
    { "Aqua_ac_Arms", "Aqua Arms" },
    { "Aqua_ac_Chest", "Aqua Chest" },
    { "Aqua_ac_Feet", "Aqua Feet" },
    { "Aqua_ac_Head", "Aqua Head" },
    { "Aqua_ac_Legs", "Aqua Legs" },
    
    { "Base_aa_Chest", "Base Chest" },
    { "Base_aa_Feet", "Base Feet" },
    { "Base_aa_Legs", "Base Legs" },
    { "Base_ab_Arms", "Base Arms" },
    { "Base_ab_Belt", "Base Belt" },
    { "Base_ab_Chest", "Base Chest" },
    { "Base_ab_Feet", "Base Feet" },
    { "Base_ab_Head", "Base Head" },
    { "Base_ab_Legs", "Base Legs" },
    { "Base_ac_Arms", "Base Arms" },
    { "Base_ac_Chest", "Base Chest" },
    { "Base_ac_Feet", "Base Feet" },
    { "Base_ac_Head", "Base Head" },
    { "Base_ac_Legs", "Base Legs" },
    
    { "Bolt_aa_Chest", "Bolt Chest" },
    { "Bolt_aa_Feet", "Bolt Feet" },
    { "Bolt_aa_Legs", "Bolt Legs" },
    { "Bolt_ab_Arms", "Bolt Arms" },
    { "Bolt_ab_Belt", "Bolt Belt" },
    { "Bolt_ab_Chest", "Bolt Chest" },
    { "Bolt_ab_Feet", "Bolt Feet" },
    { "Bolt_ab_Head", "Bolt Head" },
    { "Bolt_ab_Legs", "Bolt Legs" },
    { "Bolt_ab_Shoulders", "Bolt Shoulders" },
    { "Bolt_ac_Arms", "Bolt Arms" },
    { "Bolt_ac_Belt", "Bolt Belt" },
    { "Bolt_ac_Chest", "Bolt Chest" },
    { "Bolt_ac_Feet", "Bolt Feet" },
    { "Bolt_ac_Head", "Bolt Head" },
    { "Bolt_ac_Legs", "Bolt Legs" },
    { "Bolt_ac_Shoulders", "Bolt Shoulders" },

    { "Cold_aa_Chest", "Cold Chest" },
    { "Cold_aa_Feet", "Cold Feet" },
    { "Cold_aa_Legs", "Cold Legs" },
    { "Cold_ab_Arms", "Cold Arms" },
    { "Cold_ab_Belt", "Cold Belt" },
    { "Cold_ab_Chest", "Cold Chest" },
    { "Cold_ab_Feet", "Cold Feet" },
    { "Cold_ab_Head", "Cold Head" },
    { "Cold_ab_Legs", "Cold Legs" },
    { "Cold_ab_Shoulders", "Cold Shoulders" },
    { "Cold_ac_Arms", "Cold Arms" },
    { "Cold_ac_Belt", "Cold Belt" },
    { "Cold_ac_Chest", "Cold Chest" },
    { "Cold_ac_Feet", "Cold Feet" },
    { "Cold_ac_Head", "Cold Head" },
    { "Cold_ac_Legs", "Cold Legs" },
    { "Cold_ac_Shoulders", "Cold Shoulders" },

    { "Dark_aa_Chest", "Dark Chest" },
    { "Dark_aa_Arms", "Dark Arms" },
    { "Dark_aa_Feet", "Dark Feet" },
    { "Dark_aa_Legs", "Dark Legs" },
    { "Dark_ab_Arms", "Dark Arms" },
    { "Dark_ab_Belt", "Dark Belt" },
    { "Dark_ab_Chest", "Dark Chest" },
    { "Dark_ab_Feet", "Dark Feet" },
    { "Dark_ab_Head", "Dark Head" },
    { "Dark_ab_Legs", "Dark Legs" },
    { "Dark_ab_Shoulders", "Dark Shoulders" },
    { "Dark_ac_Arms", "Dark Arms" },
    { "Dark_ac_Chest", "Dark Chest" },
    { "Dark_ac_Feet", "Dark Feet" },
    { "Dark_ac_Head", "Dark Head" },
    { "Dark_ac_Legs", "Dark Legs" },
    { "Dark_ac_Shoulders", "Dark Shoulders" },

    { "Fire_aa_Chest", "Fire Chest" },
    { "Fire_aa_Legs", "Fire Legs" },
    { "Fire_ab_Arms", "Fire Arms" },
    { "Fire_ab_Belt", "Fire Belt" },
    { "Fire_ab_Chest", "Fire Chest" },
    { "Fire_ab_Feet", "Fire Feet" },
    { "Fire_ab_Head", "Fire Head" },
    { "Fire_ab_Legs", "Fire Legs" },
    { "Fire_ab_Shoulders", "Fire Shoulders" },
    { "Fire_ac_Arms", "Fire Arms" },
    { "Fire_ac_Chest", "Fire Chest" },
    { "Fire_ac_Feet", "Fire Feet" },
    { "Fire_ac_Head", "Fire Head" },
    { "Fire_ac_Legs", "Fire Legs" },
    { "Fire_ac_Shoulders", "Fire Shoulders" }
  };
  ...
  public static Dictionary<string, List<string>> gearParts { get; } = new Dictionary<string, List<string>> {
    ...
    { "Base_ab_Chest", new List<string> { "Torso", "ArmRight", "ArmLeft" } },
    ...
    { "Base_ac_Chest", new List<string> { "Torso", "ArmRight", "ArmLeft", "Neck" } },
    ...
    { "Base_ad_Chest", new List<string> { "Torso", "Neck" } },
    ...
    { "Bolt_ac_Belt", new List<string> { "BeltFlap" } },
    { "Bolt_ac_Chest", new List<string> { "Torso", "Neck", "FlapLeft", "FlapRight", "ArmRight", "ArmLeft" } },
