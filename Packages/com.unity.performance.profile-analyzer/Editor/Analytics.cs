...
namespace UnityEditor.Performance.ProfileAnalyzer
{
    class ProfileAnalyzerAnalytics
    {
        ...
        static AnalyticsResult RegisterUsabilityEvent()
        {
#pragma warning disable CS0618 // EditorAnalytics legacy API kept for compatibility with this embedded package version
            return EditorAnalytics.RegisterEventWithLimit(k_EventTopicName, k_MaxEventsPerHour, k_MaxEventItems, k_VendorKey);
#pragma warning restore CS0618
        }

        static AnalyticsResult SendUsabilityEvent<TEvent>(TEvent evt)
        {
#pragma warning disable CS0618 // EditorAnalytics legacy API kept for compatibility with this embedded package version
            return EditorAnalytics.SendEventWithLimit(k_EventTopicName, evt);
#pragma warning restore CS0618
        }

        public static void EnableAnalytics()
        {
            AnalyticsResult result = RegisterUsabilityEvent();
        ...
        public static bool SendUIButtonEvent(UIButton uiButton, float durationInSeconds)
        {
            ...
            AnalyticsResult result = SendUsabilityEvent(uiButtonEvent);
            if (result != AnalyticsResult.Ok)
                return false;
        ...
        public static bool SendUIUsageModeEvent(UIUsageMode uiUsageMode, float durationInSeconds)
        {
            ...
            AnalyticsResult result = SendUsabilityEvent(uiUsageEvent);
            if (result != AnalyticsResult.Ok)
                return false;
        ...
        public static bool SendUIResizeEvent(UIResizeView uiResizeView, float durationInSeconds, float width, float height, bool isDocked)
        {
            ...
            AnalyticsResult result = SendUsabilityEvent(uiResizeEvent);
            if (result != AnalyticsResult.Ok)
                return false;
